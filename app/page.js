...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center p-10 bg-slate-800">
      <div className="bg-slate-100 flex-col  w-full h-fit justify-center rounded-md relative">
        {/* Features Section */}
        <div className="px-3 py-1 @media bg-red-400 w-full h-auto rounded-r-md  rounded-b-md items-center flex flex-wrap gap-3 ">
          ...
          <div className="w-max h-10 justify-center items-center flex gap-3">
            <LuUndo2 className="cursor-pointer text-black hover:text-white" />
            <LuRedo2 className="cursor-pointer text-black hover:text-white" />
          </div>
          ...
          <div className="flex gap-4 ml-6">
            <FaAlignLeft className="cursor-pointer text-black hover:text-white " />
            <FaAlignCenter className="cursor-pointer text-black hover:text-white" />
            <FaAlignRight className="cursor-pointer text-black hover:text-white" />
          </div>
          ...
          <div className="flex gap-2 items-center justify-center ml-6">
            <FaMinus className="cursor-pointer text-black hover:text-white size-3" />
